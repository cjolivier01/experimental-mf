#ifndef CONDITION_ALGORITHM_8A_H
#define CONDITION_ALGORITHM_8A_H
////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////
//
...
class condition_algorithm_8a
{
 ...
 public:
  ...
  static bool wait  ( ConditionMembers &data, Lock &lock
    , bool timeout_enabled, const Time::time_point &abs_time);
...
inline bool condition_algorithm_8a<ConditionMembers>::wait
  ( ConditionMembers &data
    , Lock &lock
    , bool tout_enabled
    , const Time::time_point &abs_time
  )
{
...
class condition_8a_wrapper
{
 ...
 public:
  ...
  void wait(L& lock)
  {
    ...
    algo_type::wait(m_data, lock, false, Time::time_point());
  }
  ...
  template <typename L>
  bool timed_wait(L& lock, const Time::time_point &abs_time)
  {
    if (!lock)
      throw lock_exception();
  ...
  template <typename L, typename Pr>
  bool timed_wait(L& lock, const Time::time_point &abs_time, Pr pred)
  {
    if (!lock)
      throw lock_exception();
    while (!pred()){
...
#endif //CONDITION_ALGORITHM_8A_H