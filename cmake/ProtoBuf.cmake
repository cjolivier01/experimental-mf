...
list(APPEND fastmf_LINKER_LIBS ${PROTOBUF_LIBRARIES})
...
set(proto_gen_folder "${PROJECT_BINARY_DIR}/include/fastmf/proto")
...
# Usage:
#   fastmf_protobuf_generate_cpp_py(<output_dir> <srcs_var> <hdrs_var> <python_var> <proto_files>)
function(fastmf_protobuf_generate_cpp_py output_dir srcs_var hdrs_var python_var work_path proto_path)
  if(NOT ARGN)
    message(SEND_ERROR "Error: fastmf_protobuf_generate_cpp_py() called without any proto files")
    return()
  endif()
